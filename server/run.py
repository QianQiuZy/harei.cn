...
def upload():
    ...
    new_message = MessageService.create_message(guest_id=guest_id, message_text=message_text)
    ...
    for key, image in files.items():
        ...
        ImageService.create_image(message_id=new_message.message_id, image_path=image_path)
...
def uploaded_file(filename):
    ...
    uploads_path = os.path.abspath(os.path.join(app.config['UPLOAD_FOLDER'], '../uploads'))
...
def message():
    ...
    for msg in messages:
        ...
        if images:
            ...
            image_urls = ['https://www.baidu.com/img/PCtm_d9c8750bed0b3c7d089fa7d55720d6cf.png']  # 使用占位符图片
